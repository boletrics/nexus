...
import { Menu, MousePointer2, Hand, Armchair, Users, Square, Circle, Grid3X3, DollarSign } from "lucide-react"

export function MobileToolbar() {
  const { mode, activeTool, setActiveTool, showGrid, setShowGrid, selectedTier, setSelectedTier } = useEditor()
    ...
    <div className="fixed bottom-4 left-1/2 z-20 -translate-x-1/2 lg:hidden">
      <Sheet>
        ...
        <SheetContent side="bottom" className="h-[50vh]">
          <SheetHeader>
            <SheetTitle>{mode === "edit" ? "Edit Tools" : "Tier Assignment"}</SheetTitle>
          </SheetHeader>
          <ScrollArea className="mt-4 h-full pb-8">
            {mode === "edit" ? (
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">Add Elements</p>
                  <div className="grid grid-cols-2 gap-2">
                    <ToolButton
              ...
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">Select a tier and tap on elements to assign pricing</p>
                  ...
                  {TIERS.map((tier) => (
                    <button
                      ...
                      className={cn(
                        ...
                        selectedTier === tier.id ? "border-primary bg-primary/10" : "border-border hover:bg-muted",
                      )}
                    >
                      <div
                        className={cn(
